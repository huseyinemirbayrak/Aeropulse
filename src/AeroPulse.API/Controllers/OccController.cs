    ...
    public async Task<IActionResult> GetRampTasks([FromQuery] string? filter)
    {
        var list = await _context.TurnaroundTasks
            ...
            .Select(t => new RampTaskDto
            {
                Id = t.Id,
                OperationId = t.OperationId,
                FlightNumber = t.Operation.FlightNumber,
                GateNo = t.Operation.GateNo,
                AssignedRunwayCode = t.Operation.AssignedRunwayCode,
                AircraftTailNumber = t.Operation.Aircraft != null ? t.Operation.Aircraft.TailNumber : "N/A",
                AircraftModel = t.Operation.Aircraft != null ? t.Operation.Aircraft.Model : "A320/B737",
                TaskType = t.TaskType,
